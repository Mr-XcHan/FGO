...
#SBATCH --output=/mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/logs/ZR1_LengthThreshold_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/ZR1-1.5B_Length_Threshold \
