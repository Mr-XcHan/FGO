...
#SBATCH --output=/vol/research/ly0008/xch/code/CEWE_/logs/Qwen_Ins_LengthThreshold_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /vol/research/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/Qwen2.5-Math-1.5B-Instruct_Length_Threshold \
