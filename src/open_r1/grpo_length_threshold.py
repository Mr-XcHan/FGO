...
from open_r1.rewards_length_threshold import get_reward_funcs
...
def main(script_args, training_args, model_args):
    ...
    wandb.init(project=project_name, name="Length_Threshold_GRPO_" + timestr)
    ...
    if 'simplelr_qwen_level3to5' in script_args.dataset_name:
        ...
        dataset = load_dataset(script_args.dataset_name, name=script_args.dataset_config)['train'].select(range(training_args.max_steps))
