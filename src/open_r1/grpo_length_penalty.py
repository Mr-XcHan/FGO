...
from open_r1.rewards_length_penalty import get_reward_funcs
...
def main(script_args, training_args, model_args):
    ...
    if 'simplelr_qwen_level3to5' in script_args.dataset_name:
        ...
        dataset = load_dataset(script_args.dataset_name, name=script_args.dataset_config)['train'].select(range(5000))
