#!/bin/bash
#SBATCH --job-name=DPSK_GRPO
#SBATCH --partition=a100
#SBATCH --nodes=1                       
#SBATCH --gres=gpu:1                   # ⬅️ 每节点申请2个GPU
#SBATCH --ntasks-per-node=1
#SBATCH --time=48:00:00
#SBATCH --output=/vol/research/ly0008/xch/code/CEWE_/logs/DPSK_GRPO_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /vol/research/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/DeepSeek-R1-Distill-Qwen-1.5B_pure \
