...
#SBATCH --output=/vol/research/ly0008/xch/code/CEWE_/logs/ZR1_wrong_wo_Length_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /vol/research/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/ZR1-1.5B_wrong_wo_Length \
