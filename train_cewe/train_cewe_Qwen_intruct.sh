...
#SBATCH --output=/vol/research/ly0008/xch/code/CEWE_/logs/Qwen_Instruct_CEWE_%j_%t.out
...
accelerate launch \
  ...
  src/open_r1/grpo.py \
  --config /vol/research/ly0008/xch/code/CEWE_/recipes/Qwen2.5-Math-Qwen2.5-1.5B-Instruct/grpo/config_demo.yaml \
