...
#SBATCH --output=FGO/logs/Qwen_Math_wo_Entropy_%j_%t.out
...
accelerate launch \
  ...
  FGO/src/open_r1/grpo_wo_entropy.py \
  --config FGO/recipes/Qwen2.5-Math-1.5B/grpo/config_demo.yaml \
  --output_dir FGO/output_logs/CEWE/GRPO/Qwen2.5-Math-1.5B_wo_Entropy \
