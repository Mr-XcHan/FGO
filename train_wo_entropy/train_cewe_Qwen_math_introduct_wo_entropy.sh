#!/bin/bash
#SBATCH --job-name=Qwen_Ins_w/oE
#SBATCH --partition=a100
#SBATCH --nodes=1                       
#SBATCH --gres=gpu:2                   # ⬅️ 每节点申请2个GPU
#SBATCH --ntasks-per-node=1
#SBATCH --time=48:00:00
#SBATCH --output=/mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/logs/Qwen_Ins_wo_Entropy_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/Qwen2.5-Math-1.5B-Instruct_wo_Entropy \
