#!/bin/bash
#SBATCH --job-name=Qwen_Ins_w/oL
#SBATCH --partition=a100
#SBATCH --nodes=1                       
#SBATCH --gres=gpu:2                   # ⬅️ 每节点申请2个GPU
#SBATCH --ntasks-per-node=1
#SBATCH --time=48:00:00
#SBATCH --output=/mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/logs/Qwen_Ins_wo_Length_%j_%t.out
...
accelerate launch \
  ...
  /mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/src/open_r1/grpo_wo_length.py \
  --config /mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/recipes/Qwen2.5-1.5B-Instruct/grpo/config_demo.yaml \
  --output_dir /mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/Qwen2.5-Math-1.5B-Instruct_wo_Length \
