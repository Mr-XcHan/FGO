...
#SBATCH --output=/vol/research/ly0008/xch/code/CEWE_/logs/Qwen_Ins_wo_Length_%j_%t.out
...
accelerate launch \
  ...
  /vol/research/ly0008/xch/code/CEWE_/src/open_r1/grpo_wo_length.py \
  --config /vol/research/ly0008/xch/code/CEWE_/recipes/Qwen2.5-1.5B-Instruct/grpo/config_demo.yaml \
  --output_dir /vol/research/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/Qwen2.5-Math-1.5B-Instruct_wo_Length \
