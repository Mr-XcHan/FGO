...
#SBATCH --output=/mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/GPG/open-r1/logs/ZR1_wo_Length_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /mnt/fast/nobackup/scratch4weeks/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/ZR1-1.5B_wo_Length \
