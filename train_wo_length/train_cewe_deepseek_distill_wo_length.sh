...
#SBATCH --output=/vol/research/ly0008/xch/code/CEWE_/logs/deepseek_wo_Length_%j_%t.out
...
accelerate launch \
  ...
  --output_dir /vol/research/ly0008/xch/code/CEWE_/output_logs/CEWE/GRPO/DeepSeek-R1-Distill-Qwen-1.5B_wo_Length \
